    ...
    public void PDFAB ( String Headline, int AmountExer, GUISETTINGSPDF k, boolean Lösungen )
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= AmountExer; i++)
            {
                ...
                for ( int c = 0; c < k.AnzAuf && c < 100 ; c++)
                {
                    Exercises[i][c] = new TERM(k.aoAddition,k.aoSubtraction,k.aoMultiplication,k.aoDivision,k.bracketDepht,k.Substitutions,k.Digits,k.justPositive,k.withFraction).infix() + "=";
